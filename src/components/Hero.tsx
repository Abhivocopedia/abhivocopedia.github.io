...
import { Arrow, DotPattern, Label, Star } from './DecorativeMarks'
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          >
            ...
            <Label variant="meta">CSE · 03RD SEMESTER</Label>
          </motion.div>
          ...
          >
            CSE STUDENT · FULL-STACK DEVELOPER · INDEPENDENT BUILDER
          </motion.p>
        ...
        >
          ...
          <div
            ...
            aria-hidden="true"
          >
            <span className={styles.floatItem}>CSE</span>
            <span className={styles.floatItem}>VTU</span>
            <span className={styles.floatItem}>INDIA</span>
          </div>
        </motion.div>
      </div>
